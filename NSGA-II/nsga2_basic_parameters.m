...
function [opt] = nsga2_basic_parameters(opt)
    ...
    opt.N = 100;%population size in optimization algorithm
    ...
    opt.num_Knee = 10;%number of knee points for knee based test function
    opt.knee_s = 1;%parameter for knee based test function
    ...
    if opt.M==3
        opt.dirs = [1.0000    0.0000    0.0000
            ...
            0.0000    0.0000    1.0000];%91 directions
    elseif opt.M==2

        opt.dirs = [ 0.0000001 1.0; 0.05 0.95; 0.1 0.9; 0.15 0.85; 0.2 0.8; 0.25 0.75; 0.3...
                     0.7; 0.35 0.65; 0.4 0.6; 0.45 0.55; 0.5 0.5; 0.55 0.45; 0.6 0.4; 0.65 0.35;...
                     0.7 0.3; 0.75 0.25; 0.8 0.2; 0.85 0.15; 0.9 0.1; 0.95 0.05; 1.0 0.0000001];%21 directions
    end
