...
%-------------------MAIN LOOP----------------------------------------------    
    ...
    for func_no = 14:1:14%:4%for all test functions 
        for r = 1:1:run%number of runs
            ...
            opt.totalFuncEval = opt.N * opt.G;%define number of function evaluations
            opt.pareto = load('Pareto Front/OSY.txt');%Pareto front
